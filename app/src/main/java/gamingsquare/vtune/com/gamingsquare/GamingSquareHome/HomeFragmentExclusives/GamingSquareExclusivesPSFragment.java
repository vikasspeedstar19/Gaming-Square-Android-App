...
public class GamingSquareExclusivesPSFragment extends Fragment {

    RecyclerView recyclerView;
    GamingSquareExclusivesPSData photoAlbum;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        photoAlbum = new GamingSquareExclusivesPSData(this);
        layoutManager = new LinearLayoutManager(getActivity());
        recyclerView.setLayoutManager(layoutManager);
        photoAlbumAdapter = new GamingSquareRecViewAdapter(getActivity(),photoAlbum, new GamingSquareHelper().GAMING_SQAURE_EXCLUSIVES_PS);
    ...
    public void gamingSquareAddExclusivePSListData(){
        photoAlbumAdapter.gamingSquareAddExclusivePSListData();
        mDialog.dismiss();
    }
