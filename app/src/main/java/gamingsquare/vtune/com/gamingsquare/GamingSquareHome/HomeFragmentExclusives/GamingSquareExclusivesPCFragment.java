...
public class GamingSquareExclusivesPCFragment extends Fragment{

    RecyclerView recyclerView;
    GamingSquareExclusivesPCData photoAlbum;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        photoAlbum = new GamingSquareExclusivesPCData(this);
        layoutManager = new LinearLayoutManager(getActivity());
        recyclerView.setLayoutManager(layoutManager);
        photoAlbumAdapter = new GamingSquareRecViewAdapter(getActivity(),photoAlbum, new GamingSquareHelper().GAMING_SQAURE_EXCLUSIVES_PC);
    ...
    public void gamingSquareAddExclusivePCListData(){
        photoAlbumAdapter.gamingSquareAddExclusivePCListData();
        mDialog.dismiss();
    }
